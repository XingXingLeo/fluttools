...
abstract class FlutterTableAbstract extends StatefulWidget {
  ...
  const FlutterTableAbstract({
    ...
    this.leftTopBoxTap,
    this.leftAlignment,
    this.leftTopAlignment,
    this.rightAlignment,
    this.rightTopAlignment,
    this.headerAlignment,
    this.tableAlignment,
  }) : super(key: key);
}

abstract class FlutterTableState<T extends FlutterTableAbstract>
    extends State<FlutterTableAbstract> {
  ...
  Widget headerBoxChild(BuildContext context, int xIndex) {
    return new Container(
      ...
      child: headerBoxChildContent(context, xIndex),
    );
  }
  ...
  Widget bodyBoxChild(BuildContext context, yIndex, xIndex) {
    return new Container(
      ...
      margin: EdgeInsets.all(widget.boxMargin),
      alignment: widget.tableAlignment,
      child: bodyBoxChildContent(context, yIndex, xIndex),
    );
  }
  ...
  Widget leftBoxChild(BuildContext context, int yIndex) {
    return new Container(
        ...
        child: leftBoxChildContent(context, yIndex));
  }
  ...
  Widget leftTopFixedChild(BuildContext context) {
    return Container(
        ...
        child: Container(
          ...
          height: widget.headerHeight - 2 * widget.boxMargin,
          margin: EdgeInsets.all(widget.boxMargin),
          alignment: widget.leftTopAlignment,
          child: leftTopFixedChildContent(context),
        ));
  }
...
//左侧整体列表
  ...
  Widget rightBoxChild(BuildContext context, yIndex) {
    return new Container(
      ...
      margin: EdgeInsets.all(widget.boxMargin),
      child: rightBoxChildContent(context, yIndex),
    );
  }
  ...
  Widget rightTopFixedChild(BuildContext context) {
    return Container(
        ...
        child: Container(
            width: widget.rightWidth - 2 * widget.boxMargin,
            height: widget.headerHeight - 2 * widget.boxMargin,
            alignment: widget.rightTopAlignment,
            margin: EdgeInsets.all(widget.boxMargin),
            child: rightTopFixedChildContent(context)));
  }
